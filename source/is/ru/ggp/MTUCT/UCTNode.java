...
public class UCTNode
{
	...
	IGameState state;
	UCTNode parent;//if parent == null, then this == root
	UCTNode[] children;
	double[][] aggregate;
	int[][] countVisited;
	int visits; 
	...
	public UCTNode(IGameState s, UCTNode p, int[] ppoint)
	{
		state = s;
		parent = p;
		visits = 0;
		...
		children = new UCTNode[movesIndex+1];
    ...
    public UCTNode progress(IMove[] newMove)
    {
        int moveCount;
        int playercount = 0;
